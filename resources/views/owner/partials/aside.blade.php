...
<aside class="dashboard-sidebar" id="sidebar">
        <a href="{{ route('owner.dashboard') }}" class="logo d-block">
            <img src="{{ asset('frontend') }}/images/owner_dashboard.png" style="width: 35%;" alt="logo" />
        </a>
        <div class="dashboard-sidebar-menu-wrapper">
            <nav class="dashboard-sidebar-menu">
                ...
                <img src="{{ asset('currency/owner_sidebar_currency.png') }}" alt="" style="width: 25px; height: 25px; color:white">
                    ...
                    <a href="{{ route('owner.order.index') }}" class="menu-item {{ request()->routeIs('owner.order.index') ? 'active' : '' }}">
                    <img src="{{ asset('currency/order-list.png') }}" alt="" style="width: 25px; height: 25px; color:white">
                    Order List</a>
