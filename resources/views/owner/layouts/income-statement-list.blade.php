                                ...
                                <table class="table table-bordered text-nowrap border-bottom" id="datatable">
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th class="bg-transparent border-bottom-0">Signage Id</th>
                                            <th class="bg-transparent border-bottom-0">Signage Location</th>
                                            <th class="bg-transparent border-bottom-0">Signage Type</th>
                                            <th class="bg-transparent border-bottom-0">Price per day</th>
                                            <th class="bg-transparent border-bottom-0">Total Screen Time</th>
                                            <th class="bg-transparent border-bottom-0">Total Revenue</th>
                                            </th>
    ...
    $(document).ready(function() {
        ...
        if (!$.fn.DataTable.isDataTable('#datatable')) {
            let dTable = $('#datatable').DataTable({
                ...
                ajax: {
                    url: "{{ route('owner.income-statement-list') }}",
                    type: "GET",
                },
