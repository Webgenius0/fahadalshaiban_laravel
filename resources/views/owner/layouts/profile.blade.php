...
<div class="main-content">
    <div class="profile-form-container">
        ...
        <img id="profilePreview" class="profile-img" src="{{ asset( Auth::user()->avatar ?? 'images/profile-img.png') }}" alt="Profile">
        ...
        <form class="profile-form" method="POST" action="{{ route('owner.page.profile.update') }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
