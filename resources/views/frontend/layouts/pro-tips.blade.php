...
<section class="engagements">
    <div class="my-container">
        <div class="engagements-wrapper">
            <h2 class="contact-info__title">Tips For More Engagements</h2>
            <div class="engagement-items-wrapper">
                <div class="engagement-item">
                    ...
                    <p class="engagement-item-desc">
                        Find the optimal location for your signage to meet your
                        business needs.
                    </p>
                </div>
                <div class="engagement-item">
                ...
                <div class="engagement-item">
                    <div class="engagement-item-icon">
                        <svg
                            ...
                            fill="none">
                            <path
                                d="M2.58325 25.4997C2.58325 25.4997 10.9166 8.83301 25.4999 8.83301C40.0833 8.83301 48.4166 25.4997 48.4166 25.4997C48.4166 25.4997 40.0833 42.1663 25.4999 42.1663C10.9166 42.1663 2.58325 25.4997 2.58325 25.4997Z"
                                stroke="#34B26F"
                                stroke-width="2"
                                stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path
                                d="M25.5 31.75C28.9518 31.75 31.75 28.9518 31.75 25.5C31.75 22.0482 28.9518 19.25 25.5 19.25C22.0482 19.25 19.25 22.0482 19.25 25.5C19.25 28.9518 22.0482 31.75 25.5 31.75Z"
                                stroke="#34B26F"
                                stroke-width="2"
                                stroke-linecap="round"
                                stroke-linejoin="round" />
                    ...
                    <h3 class="engagement-item-title">Eye-Catching Visuals</h3>
                    <p class="engagement-item-desc">
                        Your content will be displayed on all chosen signages within
                        24 hours.
                    </p>
                </div>
                <div class="engagement-item">
                    <div class="engagement-item-icon">
                        <svg
                            ...
                            fill="none">
                            <path
                                d="M48.4167 13L28.625 32.7917L18.2084 22.375L2.58337 38"
                                stroke="#34B26F"
                                stroke-width="2"
                                stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path
                                d="M35.9166 13H48.4166V25.5"
                                stroke="#34B26F"
                                stroke-width="2"
                                stroke-linecap="round"
                                stroke-linejoin="round" />
                    ...
                    <h3 class="engagement-item-title">Consistency is key</h3>
                    <p class="engagement-item-desc">
                        Your content will be displayed on all chosen signages within
                        24 hours.
                    </p>
                ...
                <div class="engagement-item">
                    <button class="btn-common engagement-btn">
                        Find Signage
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
