                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between border-bottom">
                            ...
                            <!-- Add New Page Button -->
                            <a href="{{route('admin.client.tutorial.create')}}" class="btn btn-primary">
...
<script>
    $(document).ready(function() {
        ...
        if (!$.fn.DataTable.isDataTable('#datatable')) {
            let dTable = $('#datatable').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.client.tutorial.index') }}",
                    type: "GET",
                },
    ...
    function statusChange(id) {
        let url = "{{ route('admin.client.tutorial.status', ':id') }}";
        $.ajax({
            type: "GET",
    ...
    function deleteItem(id) {
        let url = "{{ route('admin.client.tutorial.destroy', ':id') }}";
