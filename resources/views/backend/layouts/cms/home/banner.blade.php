        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">CMS : Banner</h1>
                    </div>
                            ...
                            <div class="tab-pane active show" id="editProfile">
                                <div class="card">
                                    <div class="card-body border-0">
                                        <form method="POST" action="{{ route('admin.cms.home.banner.update') }}"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description"
                                                            placeholder="Enter here description" rows="3">{{ $banner->description ?? '' }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            id="btn_text" value="{{ $banner->btn_text ?? '' }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
