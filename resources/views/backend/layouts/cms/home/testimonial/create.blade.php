@extends('backend.app', ['title' => 'Create testimonial'])
    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <div>
                    <h1 class="page-title">CMS : Create testimonial</h1>
                </div>
                        ...
                        <div class="tab-pane active show" id="editProfile">
                            <div class="card">
                                <div class="card-body border-0">
                                    <form method="POST" action="{{ route('admin.cms.home.testimonial.store') }}" enctype="multipart/form-data">
                                        @csrf
