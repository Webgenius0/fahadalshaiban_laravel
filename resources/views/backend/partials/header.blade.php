                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="ms-auto">
                                        ...
                                        <span class="xm-title badge bg-secondary text-white fw-normal fs-12 badge-pill">
                                            <a onclick="markNotificationAsRead()" class="showall-text text-white" style="cursor:pointer">Clear</a>
                                        </span>
                                        @endif
                                    </div>
                                </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p><strong>Name:</strong> <span id="notificationName"></span></p>
                                    <p><strong>Email:</strong> <span id="notificationEmail"></span></p>
                                    <p><strong>Phone:</strong> <span id="notificationPhone"></span></p>
                                    <p><strong>Message:</strong> <span id="notificationMessage"></span></p>
                                    <p><strong>Received:</strong> <span id="notificationTime"></span></p>
                                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Fetch notifications every 60 seconds (optional)
        ...
        document.getElementById('notification').addEventListener('click', function(event) {
            ...
            if (notificationItem) {
                ...
                document.getElementById('notificationName').textContent = notificationData.name;
                document.getElementById('notificationEmail').textContent = notificationData.email;
                document.getElementById('notificationPhone').textContent = notificationData.phone;
                document.getElementById('notificationMessage').textContent = notificationData.message;
                document.getElementById('notificationTime').textContent = new Date(notificationData.created_at).toLocaleString();
        ...
        fetch('/notifications')
            ...
            .then(data => {
                ...
                data.forEach(notification => {
                    ...
                    notificationItem.dataset.notification = JSON.stringify({
                        id: notification.id,
                        ...
                        read_at: notification.read_at // Include read_at status
                    });

                    // Optionally, style the notification differently if it is read
                    if (notification.read_at) {
                        notificationItem.classList.add('read'); // Add a 'read' class to style it
                    }
                    ...
                    <div class="notification-each d-flex ">
                        ...
                        <div>
                            <span class="notification-label mb-1">${notification.data.header}</span>
                            <span class="notification-subtext text-muted">${new Date(notification.created_at).toLocaleTimeString()}</span>
                        </div>
                    </div>
                `;
        ...
        fetch(`/notifications/${notificationId}/mark-as-read`, {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    // Optionally update UI (e.g., change the style of the notification or remove it from the list)
                } else {
